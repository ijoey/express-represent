...
var contentTypes = {};
var rootPath = __dirname.replace('/express-represent', '').replace('/node_modules', '').replace('/lib', '');
module.exports = (function(){
	...
	function finishResponse(result, output){
	...
	self.execute = function(result){
		...
		Fs.exists(filePath, function(exists){
			contentType.execute(exists, filePath, self, result, finishResponse);
		});
	};
	return self;
})();